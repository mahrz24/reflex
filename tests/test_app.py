...
def test_initialize_with_custom_admin_dashboard(
    ...
    """
    auth_provider = test_custom_auth_admin()
    custom_admin = Admin(engine=test_get_engine, auth_provider=auth_provider)
    ...
    assert app.admin_dash.admin.auth_provider == auth_provider
